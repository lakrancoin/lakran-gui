...
UninstallDisplayIcon={app}\lakran-wallet-gui.exe
...
; Monero GUI wallet
Source: "bin\lakran-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\lakran-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
