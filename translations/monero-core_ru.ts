...
<context>
    ...
    <message>
        ...
        <translation>&lt;style type=&apos;text/css&apos;&gt;a {text-decoration: none; color: #3bacf0; font-size: 14px;}&lt;/style&gt;                        Ищите настройки уровня конфиденциальности и адресную книгу? Кликните на вкладку &lt;a href=&apos;#&apos;&gt;Отправить&lt;/a&gt;</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Майнинг на вашем компьютере помогает обезопасить сеть Lakran. Чем больше людей майнит, тем сложнее атаковать сеть, и каждый майнер вносит свой вклад в этот процесс. &lt;br&gt; &lt;br&gt;Майнинг также дает вам небольшой шанс добыть несколько монет Lakran. Ваш компьютер будет искать хеши для решения блоков. Если вы найдете блок, то получите вознаграждение. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>С достаточным количеством Lakran</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Lakran</source>
        <translation>С недостаточным количеством Lakran</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Lakran</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Lakran или их клонов, которые смогут повторно использовать ключи Lakran.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Lakran потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Lakran.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных входов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Lakran и доступен на веб-сайте getmonero.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн (и блокчейны клонов Lakran) самостоятельно, используя инструмент monero-blockchain-blackball, чтобы создать список известных потраченых входов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Во избежание аннулирования защиты, обеспечиваемой кольцевыми подписями Lakran, выход не должен проводиться с разными кольцами на разных блокчейнах. Хотя это, как правило, не вызывает беспокойства, он может стать одним, если какой-то клон Lakran, использующий ключ повторно, позволяет вам тратить существующие выходы. В этом случае вам необходимо обеспечить, чтобы эти существующие выходы использовали одно и то же кольцо для обеих цепей.&lt;br&gt;Это может быть сделано автоматически Lakran или любым программным обеспечением с возможностью повторного использования ключей, которое не будет пытатся лишить вас конфиденциальности.&lt;br&gt;Если вы используете клон Lakran с повторным использованием ключа, и этот клон не включает эту защиту, вы все равно можете гарантировать, что ваши транзакции будут защищены, сделав их сначала на клоне, затем вручную добавить кольцо на этой странице, что позволит вам конфиденциально перевести ваши Lakran.&lt;br&gt;Если вы не используете клон Lakran с повторным использованием ключей без этих функций безопасности, то вам не нужно ничего делать, поскольку все автоматизировано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Lakran, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Lakran отправлены успешно</translation>
    </message>
    <message>
...
Пожалуйста произведите обновление программного обеспечения или подключитесь к другому демону</translation>
    ...
    <message>
        ...
        <translation>&lt;style type=&apos;text/css&apos;&gt;a {text-decoration: none; color: #3bacf0; font-size: 14px;}&lt;/style&gt;&lt;font size=&apos;2&apos;&gt; (&lt;/font&gt;&lt;a href=&apos;#&apos;&gt;Запустить демона&lt;/a&gt;&lt;font size=&apos;2&apos;&gt;)&lt;/font&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Мы почти готовы к работе. Необходимо еще сделать некоторые настройки для Lakran</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Lakran blockchain?</source>
        <translation>Запустим блокчейн Lakran ?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Майнинг защищает сеть Lakran, а также платит небольшую награду за проделанную работу. Эта опция позволяет Lakran майнить, когда ваш компьютер включен и простаивает. Когда вы продолжите работать, он прекратит майнинг.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Для того, чтобы обмениваться данными з сетью Lakran ваш кошелек должен быть подключен к ноде Lakran. Для лучшей конфиденциальности рекомендуется запустить собственную ноду.                         &lt;br&gt;&lt;br&gt;                         Если у вас нет возможности запустить собственную ноду, есть возможность подключится к удаленной ноде.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработка Lakran полностью поддерживается пожертвованиями</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Lakran!</translation>
    </message>
    <message>
...
Индекс адреса траты: </translation>
    ...
    <message>
        ...
        <translation>Lakran отправлено успешно: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 LAK, с %2 подтверждениями</translation>
    </message>
    <message>
        <location filename="../main.qml" line="873"/>
        <source>Good signature</source>
